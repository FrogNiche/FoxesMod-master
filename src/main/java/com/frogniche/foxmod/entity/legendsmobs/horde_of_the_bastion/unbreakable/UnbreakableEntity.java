...
public class UnbreakableEntity extends Monster implements IAnimatable {


    public static final String CONTROLLER_NAME = "controller";

    public static AttributeSupplier createAttributes() {
        return Monster.createMobAttributes().add(Attributes.MAX_HEALTH, 200)
    ...
    public UnbreakableEntity(EntityType<? extends Monster> p_33002_, Level p_33003_) {super(p_33002_, p_33003_);}
    ...
    private PlayState attackPredicate(AnimationEvent<UnbreakableEntity> event) {
    ...
    private PlayState predicate(AnimationEvent<UnbreakableEntity> event) {
        if (event.isMoving()) {
